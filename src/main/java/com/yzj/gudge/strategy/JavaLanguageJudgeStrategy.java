...
import com.yzj.model.dto.question.JudgeCase;
import com.yzj.model.dto.question.JudgeConfig;
...
public class JavaLanguageJudgeStrategy implements JudgeStrategy{
    ...
    public JudgeInfo doJudge(JudgeContext judgeContext) {
        ...
        //如果传入的值为 null，则返回一个包含 null 值的 Optional 对象；如果传入的值不为 null，则返回一个包含该值的 Optional 对象
